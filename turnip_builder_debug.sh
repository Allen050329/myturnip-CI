...
meson build-android-aarch64 --cross-file \
       ...
       -Dgallium-nine=true -Dgallium-opencl=icd -Dbuildtype=debug -Dplatforms=android \
       ...
       -Dglx=disabled -Dgles2=enabled -Dgles1=enabled -Dllvm=enabled &> $workdir/meson_log_dreno_dbg.log



echo "Compiling build files ..." $'\n'
ninja -C build-android-aarch64 &> $workdir/ninja_log_dreno_dbg.log
